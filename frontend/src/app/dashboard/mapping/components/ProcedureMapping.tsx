  ...
  return (
    <div className="space-y-3">
      ...
      <div className="px-4 py-3 border-b border-border dark:border-border-dark flex items-center gap-3">
        ...
        <span className="font-mono text-base font-bold text-primary">{procedureName}</span>
      ...
      <div className="mx-4 flex items-center gap-4 flex-wrap">
        ...
        <div className="flex rounded-lg border border-border dark:border-border-dark overflow-hidden">
          <button
            onClick={() => onCallModeChange('NAMED')}
          ...
          <button
            onClick={() => onCallModeChange('ARRAY')}
            ...
            <thead>
              <tr className="border-b border-border dark:border-border-dark bg-surface dark:bg-background-dark">
                ...
                <th className="text-left px-4 py-2.5 text-xs font-bold uppercase tracking-wider text-muted-foreground">
                  {t('mapping.argumentName')}
                </th>
                <th className="text-left px-4 py-2.5 text-xs font-bold uppercase tracking-wider text-muted-foreground w-28">
                  {t('mapping.dataType')}
                </th>
                ...
                <th className="text-left px-4 py-2.5 text-xs font-bold uppercase tracking-wider text-muted-foreground w-20">
                  {t('mapping.required')}
                </th>
              </tr>
            </thead>
                ...
                return (
                  <tr key={param.ARGUMENT_NAME}
                    ...
                    <td className="px-4 py-2">
                      <span className="font-mono text-sm font-bold">{param.ARGUMENT_NAME}</span>
                    </td>
                    <td className="px-4 py-2">
                      <span className="text-sm text-muted-foreground font-mono">{param.DATA_TYPE}</span>
                    </td>
                    <td className="px-4 py-2 text-center">
